  ...
  for (let prop in activeTab) {
    if (activeTab.hasOwnProperty(prop)) {
      ...
      row2.insertCell(0).innerHTML =
        ...
        " " +
        `<input type="button" id="editButton${count}" value="Edit">`;
      ...
      document.getElementById(edit).addEventListener("click", function () {
        ...
        console.log(
          document.getElementById("myTable").childNodes[1].childNodes[
            itemId - 1
          ].childNodes[0].childNodes[0].id
        );

        let str2 = document.getElementById("myTable").childNodes[1].childNodes[
          itemId - 1
        ].childNodes[0].childNodes[0].id;
      ...
      row.addEventListener("click", function () {
        ...
        for (
          let x = 0;
          x < document.getElementById("myTable").childNodes[1].children.length;
          x++
        ) {
          //     console.log(this);
          if (table.childNodes[1].childNodes[x] == this) {
            ...
            if (
              document.getElementById("myTable").childNodes[1].childNodes[x + 1]
