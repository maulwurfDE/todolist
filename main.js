...
console.log(dates.sort(date_fns__WEBPACK_IMPORTED_MODULE_1__["compareAsc"]));
    ...
    for (let prop in activeTab) {
        ...
        if (activeTab.hasOwnProperty(prop)) {
            ...
            document.getElementById(edit).addEventListener('click', function () {
                ...
                console.log(_projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[3]);
                ...
                document.getElementById("editTitle").value = _projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[e].name;
            ...
            editSave.addEventListener('click', function () {
                ...
                _projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[e].name = document.getElementById("editTitle").value;
                _projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[e].description = document.getElementById("editDescription").value;
                _projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[e].priority = document.getElementById("editPriority").value;
                _projectController_js__WEBPACK_IMPORTED_MODULE_0__["createdProjects"][obj2].todolist[e].dueDate = document.getElementById("editDueDate").value;
                    }
                }
